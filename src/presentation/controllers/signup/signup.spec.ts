...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if email is not provided', async () => {
    ...
    const httpResponse = await sut.handle(httpRequest)
    expect(httpResponse.statusCode).toBe(400)
    expect(httpResponse.body).toEqual<Error>(new MissingParamError('email'))
  })
  ...
  test('Should return 400 if password is not provided', async () => {
    ...
    const httpResponse = await sut.handle(httpRequest)
    expect(httpResponse.statusCode).toBe(400)
    expect(httpResponse.body).toEqual<Error>(new MissingParamError('password'))
  })
  ...
  test('Should return 400 if invalid email was provided', async () => {
    ...
    const httpResponse = await sut.handle(httpRequest)
    expect(httpResponse.statusCode).toBe(400)
    expect(httpResponse.body).toEqual<Error>(new InvalidParamError('email'))
  })
  ...
  test('Should return 500 if EmailValidator throws', async () => {
    ...
    expect(httpResponse.body).toEqual<Error>(new ServerError())
  })
